...
| [`docs/design/wireframes/phone/DESIGN.md`](docs/design/wireframes/phone/DESIGN.md) | スマホ画面設計（横断） |
| [`docs/design/wireframes/display/DESIGN.md`](docs/design/wireframes/display/DESIGN.md) | ディスプレイ画面設計（横断） |
