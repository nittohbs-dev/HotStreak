...
画面ラフ: [phone/DESIGN.md](../../wireframes/phone/DESIGN.md) / [display/DESIGN.md](../../wireframes/display/DESIGN.md)
...
## ワイヤー（参考）
- ディスプレイ: `docs/design/wireframes/display/DESIGN.md`
- スマホ: `docs/design/wireframes/phone/DESIGN.md`
