...
| パス | 内容 |
|------|------|
| [phone/screens.md](./phone/screens.md) | スマホ画面設計（MD・SCR-phone-*） |
| [display/screens.md](./display/screens.md) | ディスプレイ画面設計（MD・SCR-display-*） |
...
画面IDの草案は上記 `screens.md`。機能詳細設計では `features/<id>/screens.md` へ移植・REQ 紐付けする。
