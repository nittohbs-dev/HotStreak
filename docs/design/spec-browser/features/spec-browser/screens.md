...
|--------|------|---------|---------|------------------|--------|
| SCR-sb-001 | キャンバス本体 | REQ-sb-002,003,005〜013 | — | CMP-sb-001〜008 | 同一 |
...
| 左 | アウトライン（機能チェック＋層/API/TBL 折りたたみ） | 機能マルチ選択・ノード選択・セクション開閉 |
...
+--------+----------------------------------------+----------------+
| アウトライン|  キャンバス（表示分を詰め直し）         | インスペクタ   |
| ▼ 機能    |  Feature(s) → Class → Table         | 概要・JSON    |
